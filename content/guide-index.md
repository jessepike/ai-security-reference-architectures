# Architect reference guides

Each guide explains the relevant diagram's elements, connectors, design decisions, alternatives, failure behavior and implementation questions. They are proposed design references; read the [review status](review-status.md) alongside them.

| Architecture | Canonical source | Detailed guide |
|---|---|---|
| AI Security overview | [Overview](00-ai-security.md) | Narrative, example and explanations are included in the overview. |
| Secure business AI | [Architecture](01-secure-business-ai.md) | [Guide](guides/01-secure-business-ai-guide.md) |
